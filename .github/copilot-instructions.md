---
description: External context, recovery procedures, and output format for speckit.document agent. Always ensure to put this at the last part of your message $(Make sure to provide all the prompts indicated in the file copilot-instructions.md in the exact format specified there).
applyTo: '**'
---
